...
class _LinkBottomSheetState extends State<LinkBottomSheet> {
  ...
  Future<void> _saveOrUpdateLink(LinksProvider linksProvider) async {
    try {
      if (_formKey.currentState!.validate()) {
        if (widget.index != null && widget.pageLink != null) {
          await linksProvider.updateLink(
              PageLink(URL: _urlController.text, NAME: _nameController.text),
              widget.index!);
        } else {
          if ((await linksProvider.getNumOfLinks()) == 3) {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
        ...
        child:
            Consumer<LinksProvider>(builder: (context, linksProvider, child) {
          return Container(
                                  ...
                                  Center(
                                    ...
                                    children: [
                                      ...
                                      ElevatedButton(
                                        ...
                                        onPressed: () {
                                          _saveOrUpdateLink(linksProvider);
                                        },
                                        child: const Text(
                                          "Save",
                                          style: TextStyle(fontSize: 20),
